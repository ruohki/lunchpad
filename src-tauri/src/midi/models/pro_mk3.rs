        ...
        for y in 0..11u8 {
            for x in 0..10u8 {
                let p = match (x, y) {
                    ...
                    (_, 1) => spec(self, x, y, PadShape::Round, PadRegion::Bottom2, Some("—")),
                    (0, 10) => spec(self, x, y, PadShape::Small, PadRegion::Top, Some("Shift")),
                    (9, 10) => spec(self, x, y, PadShape::Logo, PadRegion::Other, None),
                    (_, 10) => spec(self, x, y, PadShape::Round, PadRegion::Top, Some(TOP_LABELS[x as usize - 1])),
                    (0, _) => spec(self, x, y, PadShape::Round, PadRegion::Left, Some(LEFT_LABELS[9 - y as usize])),
                    (9, _) => spec(self, x, y, PadShape::Round, PadRegion::Right, Some(RIGHT_LABELS[9 - y as usize])),
