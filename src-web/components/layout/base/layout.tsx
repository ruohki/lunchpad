...
import { COLOR_ALMOSTBLACK, COLOR_GRAY, COLOR_MENU, COLOR_NAME_BLACK, COLOR_NOTBLACK, COLOR_WHITE } from '../../globalStyle';
...
export const Tab = styled(({ title, active, ...rest}) => (
  ...
  background-color: ${(props) => props.active ? COLOR_MENU : COLOR_NAME_BLACK};
...
`
export const Row: React.FC<{ title: string }> = ({ title, children }) => (
