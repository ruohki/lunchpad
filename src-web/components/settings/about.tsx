...
import { LinkButton } from '../layout/base/button';
import { ScrollBox } from '../layout/base/scrollbox';
import { Child, Divider, Split } from '../layout/base/layout';
        ...
        <Child grow align="flex-start" >
          <Split >
            <Child text="center">
              ...
              <h5>(c) {(new Date).getFullYear()} by Tillmann Hübner (<LinkButton href="mailto:hi@till.md">hi@till.md</LinkButton>)</h5>
            </Child>
