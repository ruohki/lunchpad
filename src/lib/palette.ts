/** Novation's 128-entry LED palette (index → hex). Mirrors src-tauri/src/profile/palette.rs. */
export const NOVATION_PALETTE: readonly string[] = [
...
/** The 16 colours a first-generation Launchpad (red/green LEDs) can show. */
export const LEGACY_PALETTE: readonly string[] = [
  "#000000", "#550000", "#aa0000", "#005500", "#555500", "#ff0000", "#aa5500", "#ff5500",
  "#00aa00", "#aaaa00", "#55aa00", "#ffaa00", "#00ff00", "#55ff00", "#aaff00", "#ffff00",
];
